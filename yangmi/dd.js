...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	...
	function(dd) {
		...
		! function(a) {
			...
			a._cfg = {}, a.init = function(b) {
			...
			}, a._ = {}, a._.require = function(a, b, c) {
				if ($.isFunction(window.define) && (window.define.amd || window.define.cmd) && window.require) window.require.config({
					paths: {
						wx: a
					}
				}), window.require([b], function(a) {
					window[b] = a, c(a)
				});
				else {
					var d = document.createElement("script");
					d.type = "text/javascript", d.src = a + ".js", document.getElementsByTagName("head")[0].appendChild(d), d.onload = function() {
						c(window[b])
					}
				}
				...
				return g = 0, h = 0, i = a.is("mobile"), j = function(a, b) {
					...
					var g = function() {
						var b = +new Date;
						(!i || a.is("chrome") && b - a._cfg.lastTouch > 1e3) && d.apply(this, arguments)
					};
					f ? e.on(c, b, g) : e.on(c, g)
				}, k("start", function(a) {
					j($(this), !0);
					var b = a.touches || a.originalEvent && a.originalEvent.touches || [{}];
					b = b[0], g = b.pageX, h = b.pageY
				}), k("move", function(a) {
					var b = a.touches || a.originalEvent && a.originalEvent.touches || [{}];
					b = b[0], Math.abs(b.pageX - g) + Math.abs(b.pageY - h) > 15 ? ($(this).attr("moved", "true"), j($(this), !1)) : ($(this).attr("moved", "false"), j($(this), !0))
				}), k("end", function(a) {
			...
			function(a) {
				...
				var b = {
					decode: function(a) {
						...
						return b.href = a, {
							...
							query: b.search,
							params: function() {
								for (var f, a = {}, c = b.search.replace(/^\?/, "").split("&"), d = c.length, e = 0; d > e; e++) c[e] && (f = c[e].split("="), a[decodeURIComponent(f[0])] = decodeURIComponent(c[e].substr(f[0].length + 1)));
								return a
							}(),
					...
					encode: function(a) {
						var b = [],
							c = [];
						return b.push(a.protocol, "://"), b.push(a.host), a.port && b.push(":", a.port), b.push(a.path), $.each(a.params, function(a, b) {
							null !== b && c.push(encodeURIComponent(a) + "=" + encodeURIComponent(b))
						}), c.length > 0 && b.push("?", c.join("&")), a.hash && b.push("#", a.hash), b.join("")
					},
					get: function(a, c) {
						if (0 === arguments.length) return b.decode();
						var d = "",
							e = b.decode(c || window.location.href);
						return $.each(a.split(","), function(a, b) {
				...
				}, $.each("build,encode,decode,https".split(","), function(c, d) {
					a.query[d] = b[d]
				}), window.getQueryData = a.query, window.getQueryString = a.query, window.getQuerySting = a.query
			}(didi),
			function(a) {
				"use strict";
				var l, b = null,
					...
					h = null,
					i = function(a) {
						return c = window.document, d = c.documentElement, e = c.body, this instanceof i ? (new i.fn.init(a), void 0) : h = new i(a)
					},
					j = function(a) {
						var b = !1;
				...
				i.fn = i.prototype = {
					...
					_dialogPosi: function() {
						...
						return "auto" === h && (h = 220), j = a + (e - h - 20) / 2, k = b + (f - i) / 2, {
							top: j,
							left: k
						}
					}
				...
				}, $.each(["alert", "confirm", "loading"], function(b, c) {
					a[c] || (a[c] = l[c])
				}), a.dialog || (a.dialog = i)
			}(didi),
			function(a) {
				...
				a.getData = function(a) {
					if (window.localStorage) return localStorage[a] || null;
					var b, c = new RegExp("(^| )" + a + "=([^;]*)(;|$)");
					return b = document.cookie.match(c), b ? window.unescape ? window.unescape(b[2]) : b[2] : null
				}, a.setData = function(a, b) {
					if (window.localStorage) localStorage[a] = b;
					else {
						var c = new Date;
						c.setTime(c.getTime() + 2592e3), b = window.escape ? window.escape(b) : b, document.cookie = a + "=" + b + ";expires=" + c.toGMTString()
					}
				}, a.delData = function(b) {
					var c = a.getData(b);
					void 0 !== c && (window.localStorage ? delete localStorage[b] : document.cookie = b + "=" + c + ";expires=" + new Date(0).toGMTString())
				}, a.err = function(a) {
					console.log("ERR:" + a)
				}, a.ua = function() {
					var a = {
					...
					return $.each(a, function(a, d) {
						b[a] = d.test(c)
					}), b.ios = b.iphone || b.ipad || b.ipod, b.mobile = b.ios || b.android, b.pc = !b.mobile, b.prod = /(udache.com|diditaxi.com.cn|xiaojukeji.com)\//.test(window.location.href), b.dev = !b.prod, b.dingding = b.ding, b.ding && (b.alipay = !1), window.chrome && window.chrome && (b.chrome = !0), b.app || (b.app = !!window.DidiJSBridge), b.didi = b.app, b
				}, a.is = function(b) {
					var c = b.split(","),
						d = a.ua(),
						e = function(a) {
							var b, c;
							return (a = $.trim(a) || "") ? (b = a.split("."), c = !0, $.each(b, function(a, b) {
				...
				}, a.version = function() {}, a.version.compare = function(a, c, d) {
					return a = b(a), d = b(d), c = $.trim(c) || "", -1 !== c.indexOf("=") && a === d ? !0 : -1 !== c.indexOf(">") && a > d ? !0 : -1 !== c.indexOf("<") && d > a ? !0 : !1
				}, a.version.parse = b, c = {
					data: {},
					sign: "",
					pv: function(a) {
			...
			function(didi) {
				...
				var Share = {
					...
					Env = {
						...
						getShareCfg: function(a, b, c) {
							var d, e, f, g, h;
							return c = c || {}, b[a] === !1 ? !1 : (d = {}, e = {}, f = function(a, c) {
								var d = "";
								return $.each(Env.shareMap[c].split(","), function(c, e) {
									return b[a + e] ? (d = b[a + e], !1) : void 0
								}), d
							}, $.each(Env.shareMap, function(b) {
								var g = c[b] || b;
								e[b] = g, d[g] = f(a + "_", b) || f("", b)
							}), b.revertAppmsgTitle === !0 && ("weixin_appmsg" === a || "qq_appmsg" === a) && (g = d[e.desc], d[e.desc] = d[e.title], d[e.title] = g), h = function(a) {
								return /^\/\//.test(a) && (a = window.location.protocol + a), a
							}, d[e.link] = h(d[e.link]), d[e.icon] = h(d[e.icon]), d)
						},
						reg: function(a, b) {
							Env.cfgs[a] = b
						},
				...
				didi.env = function(a, b) {
				...
				}, $.each("reg,getShareCfg".split(","), function(a, b) {
					didi.env[b] = Env[b]
				}), didi.setShare = function(a) {
					didi.is("weixin") && didi.weixin.setShare(a), didi.is("didi") && didi.app.setShare(a), didi.is("mqq") && didi.qq.setShare(a), $.each(Env.cfgs, function(b, c) {
					...
					function(a) {
						var b = {
							...
							isInit: !1,
							init: function() {
								b.isInit || (b.isInit = !0, a._.require("//res.wx.qq.com/open/js/jweixin-1.0.0", "wx", function(a) {
									a && a.hideOptionMenu && a.hideOptionMenu(), b.getSign(function(c) {
										var d = "onMenuShareTimeline,onMenuShareAppMessage,onMenuShareWeibo,hideOptionMenu,showOptionMenu,hideMenuItems,showMenuItems,chooseWXPay,scanQRCode,checkJsApi,getLocation,chooseImage".split(","),
											e = {
												debug: !1,
										...
										e.jsApiList = d, a.config(e), a.ready(function() {
											b.isReady = !0, $.each(b.fns, function(b, c) {
												c(a)
											})
										}), a.error(function() {})
									})
							...
							setShare: function(c) {
								b.fn(function(b) {
									...
									$.each({
										...
										var i, h = "menuItem:share:" + g.menu;
										return c === !1 ? (d.push(h), void 0) : (i = a.env.getShareCfg(f, c, {
											icon: "imgUrl"
										}), i === !1 ? d.push(h) : (i.cancel = c.cancel || function() {}, i.success = function(a) {
											c.success && c.success({
												from: "weixin",
												to: f,
												status: "success",
										...
										}, b["onMenuShare" + g.fn](i), e.push(h)), void 0)
									}), d.length > 0 && b.hideMenuItems({
										menuList: d
									}), e.length > 0 && b.showMenuItems({
										menuList: e
									})
								})
							},
						...
						a.weixin = function(a) {
							return b.fn(a)
						}, $.each("getSign,setShare,is".split(","), function(c, d) {
							a.weixin[d] = b[d]
						}), a.env("weixin", b)
					}(didi),
					function(a) {
						var b = {
							...
							init: function() {
								if (!b.isInit) {
									...
									a.type = "text/javascript", a.src = "//open.mobile.qq.com/sdk/qqapi.js?_bid=152", document.getElementsByTagName("head")[0].appendChild(a), a.onload = function() {
										b.isReady = !0, $.each(b.fns, function(a, b) {
											b(window.mqq)
										})
									}
								}
							...
							setShare: function(a) {
								b.fn(function(b) {
									...
									b.data.setShareInfo(c, function() {})
								})
							}
						};
						a.qq = function(a) {
							return b.fn(a)
						}, $.each("setShare,is".split(","), function(c, d) {
							a.qq[d] = b[d]
						}), a.mqq = a.qq
					}(window.didi),
					function() {
						var ua, isAndroid, GOON, Hack, Bridge, Titan, Apollo, Share, Version = {
								cfg: {
									...
									openNativeWebPage: {
										call: function(a) {
											return didi.is("ios") && a.url && (window.location.href = a.url), GOON
										}
									},
									feeback: {
										fn: "feeback",
									...
									callNativeLogin: {
										...
										sarg: !0,
										call: function(a, b) {
											return b ? Bridge.call("callNativeLoginWithCallback", {}, b) : GOON
										}
									},
								...
								map: !1,
								init: function() {
									Version.map || (Version.map = {}, $.each(Version.cfg, function(a, b) {
										b.fn || (b.fn = a);
										var c = a.replace(/([A-Z])/g, "_$1").toLowerCase();
										Version.map[a] = b, Version.map[b.fn] = b, Version.map[c] = b, b.alias && $.each(b.alias.split(","), function(a, c) {
											Version.map[c] = b
										})
									}))
								},
								...
								formatParam: function(a, b, c) {
									...
									return d.paramKey ? "string" == typeof b && d.paramKey && (e = {}, e[d.paramKey] = b, b = e) : "object" == typeof b && d.sarg && c !== !0 && (b = JSON.stringify(b)), b
								},
								...
								getFnCfg: function(a) {
									...
									return Version.init(), Version.map[b] || Version.map[c] || Version.map[a] || {}
								},
								parse: function(a) {
									a = a || "", a = a.split("."), a.length = 4;
									var b = [];
								...
								compare: function(a, b, c) {
									return a = Version.parse(a), c = Version.parse(c), b = $.trim(b) || "", -1 !== b.indexOf("=") && a === c ? !0 : -1 !== b.indexOf(">") && a > c ? !0 : -1 !== b.indexOf("<") && c > a ? !0 : !1
								},
								version: function(a) {
									var b, c;
									if (!a) return b = /didi.passenger\/([\d\.]+)/.exec(ua), b && b[1] ? b[1] : "3.9.4";
							...
							didi = window.didi || {},
							$ = window.$ || {};
						$.each = $.each || function(a, b) {
							var c, d, e;
							if ("[object Array]" === Object.prototype.toString.call(a))
								for (c = 0, d = a.length; d > c; c++) b(c, a[c]);
							else
								for (e in a) b(e, a[e])
						}, $.isFunction = $.isFunction || function(a) {
							return "function" == typeof a
						}, ua = window.navigator.userAgent, isAndroid = /android/i.test(ua), GOON = "GOON_BRIDGE_CALL", Hack = {
							reInjection: function() {
								var b, a = {
									...
									callback: function() {
										var a = Array.prototype.slice.call(arguments, 0),
											b = a.shift(),
											c = a.shift();
										this.queue[b].apply(this, a), c || delete this.queue[b]
									}
								};
								a.callHandler = function() {
									...
									for (c = [], d = b.shift(), e = 0; e < b.length; e++) f = b[e], g = typeof f, c.push(g), "function" === g && (h = a.queue.length, a.queue[h] = f, b[e] = h);
								...
								}), window.DidiJSBridge = a, b = document.createEvent("HTMLEvents"), b.initEvent("DidiJSBridgeReady", !1, !1), document.dispatchEvent(b)
							}
						}, Bridge = {
							isPre: !1,
							isReady: !1,
							...
							getBridge: function(a) {
								...
								if (isAndroid) {
									...
									Bridge.isReady = !0, a(b)
								}, 500)
							},
							fn: function(a) {
								return 0 === arguments.length ? !0 : Version.is() ? "string" == typeof a ? Bridge.call.apply(null, arguments) : (Bridge.isReady ? Bridge.getBridge(a) : (Bridge.fns.push(a), Bridge.prepare()), void 0) : !0
							},
							call: function(fnName, params, callback) {
								var cfg, ret;
								return "function" == typeof params && (callback = params, params = {}), cfg = Version.getFnCfg(fnName), cfg.call && (ret = cfg.call(params, callback), ret !== GOON) ? ret : (Titan.supply() ? Titan.call(fnName, params, callback) : Bridge.fn(function(bridge) {
									fnName = Version.formatFn(fnName), params = Version.formatParam(fnName, params);
									var hasCallback = cfg.callback !== !1;
									hasCallback ? bridge.callHandler(fnName, params, function(data) {
										"string" == typeof data && (data = eval("(" + data + ")")), callback = callback || function() {};
							...
							on: function(a, b) {
								return Version.is() ? (isAndroid ? Titan.on(a, b) : Bridge.fn(function(c) {
							...
							open: function(a) {
								...
								a = a || {}, "string" == typeof a && (a = {
									biz: a
								}), b = Date.now(), c = "didipasnger://common_marketing_host", d = {
									1: "出租车|taxi|打车|1",
									2: "专车|udache|2",
									3: "快车|flier|fastcar|3",
									4: "顺风车|shunfengche|4",
									5: "代驾|daijia|5"
								}, e = 1, f = a.business || a.biz, f && ($.each(d, function(a, b) {
									b.indexOf(f) > -1 && (e = a)
								}), c = c + "?business=" + e), a.loading !== !1 && didi.loading && didi.loading("请稍候..."), $("<iframe>").attr({
									src: a.packageUrl || c
								}).hide().appendTo("body"), setTimeout(function() {
									var d, e, c = Date.now();
									(!b || 2500 > c - b) && (d = a.system ? "ios" === a.system ? "ios" : "android" : isAndroid ? "android" : "ios", e = a[d] || Version.downloadUrl[d], location.href = e, a.loading !== !1 && didi.loading(!1))
								}, 2e3)
							}
						}, Titan = {
							id: 0,
							...
							events: {},
							supply: function() {
								return "undefined" != typeof didi.bridge._forceTitan ? didi.bridge._forceTitan : isAndroid && Version.version(">= 4.2.1")
							},
							on: function(a, b) {
								Titan.events[a] = b
							},
							trigger: function(eventName, data) {
								var fn = Titan.events[eventName];
								fn && ("string" == typeof data && (data = eval("(" + data + ")")), fn(data))
							},
							getId: function() {
								return Titan.id++, "titan_" + Titan.id
							},
							call: function(a, b, c) {
								var f, d = Titan.getId(),
							...
							callback: function(obj) {
								if ("string" == typeof obj && (obj = eval("(" + obj + ")")), obj.id && obj.result) {
									var fn = Titan.callbacks[obj.id] || !1;
									"function" == typeof fn && fn(obj.result), delete Titan.callbacks[obj.id]
								}
								obj.handlerName && obj.data && Titan.trigger(obj.handlerName, obj.data)
							}
						}, Apollo = {
							data: !1,
							traceLog: function(a) {
							...
							init: function(a, b) {
								...
								didi.bridge.apolloGetToggle(a, function(a) {
									Apollo.data = a, b && b(c)
								})
							},
							allow: function() {
							...
							formatShareData: function(a, b) {
								...
								return b = b ? b + "_" : "", $.each(c, function(c, d) {
									...
									var c = "share_" + a;
									e[c] = e[c] || b
								}), a.revertAppmsgTitle === !0 && ("weixin_appmsg" === b || "qq_appmsg" === b) && (f = e.share_content, e.share_content = e.share_title, e.share_title = f), $.each(["icon_url", "img_url", "url"], function(a, b) {
									var c = "share_" + b;
									/^\/\//.test(e[c]) && (e[c] = window.location.protocol + e[c])
								}), e
							},
							setShare: function(a, b) {
								...
								a !== !1 && (Share.data = a, $.each(Share.shareMap, function(b, d) {
									...
									type: "page_refresh",
									name: "刷新"
								}), Bridge.fn("init_entrance", c), Bridge.fn("show_entrance"), b && "function" == typeof b && b()
							},
							share: function(a, b) {
						...
						}, didi.bridge = Bridge.fn, Version.version.parse = Version.parse, $.each({
							...
							_trigger: Titan.trigger,
							on: Bridge.on
						}, function(a, b) {
							didi.bridge[a] = b
						}), $.each(Version.cfg, function(a, b) {
							b.public !== !1 && (didi.bridge[a] = function(b, c) {
								didi.bridge(a, b, c)
							})
						}), window.didi = didi, window.dd && (window.dd.bridge = didi.bridge)
					...
					function(a) {
						var b = {
								...
								inited: !1,
								init: function() {
									!b.inited && a.is("alipay") && ($.each(b.channelMap, function(a, c) {
										b.channelMapRevert[c] = a
									}), document.addEventListener("optionMenu", function() {
										b.onOptionMenu()
									}), b.inited = !0)
								},
								onOptionMenu: function() {
									b.shareData && c.fn(function(a) {
										a.call("startShare", {
											onlySelectChannel: ["Weibo", "ALPContact", "ALPTimeLine"]
										}, function(a) {
											var d = b.channelMapRevert[a.channelName];
											d && c.share(d, b.shareData, function(a) {
												console.log(a)
											})
										})
									})
								...
								prepare: function() {
									if (!b.isPre) {
										...
										"undefined" != typeof window.AlipayJSBridge ? a() : document.addEventListener("AlipayJSBridgeReady", function() {
											a()
										}, !1), b.isPre = !0
									}
								}
							...
							c = {
								...
								setShare: function(a) {
									c.fn(function(c) {
										a === !1 ? (c.call("setOptionMenu", {
											icon: "menu"
										}), b.shareData = !1) : (c.call("setOptionMenu", {
											title: "分享",
											icon: "menu"
										}), b.shareData = a)
									})
								},
								share: function(d, e, f) {
									var g = a.env.getShareCfg(d, e, {
										icon: "iconUrl",
										link: "url",
										desc: "content"
									});
									g.contentType = "url", c.fn(function(a) {
										a.call("shareToChannel", {
											name: b.channelMap[d],
											param: g
										}, function(a) {
											f && f(a)
					...
					function(a) {
						var b = {
							...
							isInit: !1,
							init: function() {
								b.isInit || (b.isInit = !0, a._.require("//g.alicdn.com/dingding/open/1.0.1/dingtalk-promise", "__dd", function(a) {
									b.ding = a, b.getSign(function(c) {
										var d = {
											agentId: c.agentId,
											corpId: c.corpId,
							...
							getSign: function(a) {
								...
								$.ajax({
									...
									success: function(b) {
										0 === 1 * b.errno && a(b.info || b.data || b)
									}
								})
							},
							fn: function(a) {
								return b.is() ? 0 === arguments.length ? !0 : (b.isReady ? a(b.ding, !0) : (b.fns.push(a), b.init()), void 0) : !1
							}
						};
						a.ding = function(a) {
							return b.fn(a)
